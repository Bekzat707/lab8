...
bg = pygame.image.load("racerelements/background.png")
SCREEN_WIDTH = 400
SCREEN_HEIGHT = 600
SPEED = 1
SCORE = 0
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("racerelements/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("racerelements/Player.png")
        self.rect = self.image.get_rect()
...
class Coins(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("racerelements/crash.png")
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40, SCREEN_WIDTH - 40), 0)
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound("racerelements/crash.wav").play()
        time.sleep(0.5)
